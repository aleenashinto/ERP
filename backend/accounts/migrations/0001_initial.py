    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('HR', 'HR'), ('MANAGER', 'Manager'), ('TEAM_LEAD', 'Team Lead'), ('EMPLOYEE', 'Employee'), ('ACCOUNTANT', 'Accountant')], default='EMPLOYEE', max_length=20)),
